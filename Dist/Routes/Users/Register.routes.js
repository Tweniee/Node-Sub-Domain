...
//* <------------------------------------for Login User------------------------------------------------->
router.post("/", RequestLimiter_1.apiLimiterMiddleware, Register_validator_1.registerValidation, (0, AsyncMiddleware_1.asyncMiddleware)(Register_controller_1.RegisterController));
