...
// * <----------------------Create Service----------------------->
router.post("/create", [
    Service_validators_1.checkCreateServiceValidation,
    Service_validators_1.checkFileUploadValidation,
    (0, RBAC_Middleware_1.authorize)([UniqueValues_1.default.SUPER_ADMIN]),
], (0, AsyncMiddleware_1.asyncMiddleware)(Service_Controller_1.createServiceController));
// * <----------------------Update Service----------------------->
router.patch("/update", [
    Service_validators_1.checkUpdateServiceValidation,
    (0, RBAC_Middleware_1.authorize)([UniqueValues_1.default.SUPER_ADMIN]),
], (0, AsyncMiddleware_1.asyncMiddleware)(Service_Controller_1.updateServiceController));
